...
#next step– rerun everything with this new data

length(unique(clean_df\$ProlID))
...
string_to_find <- "657f8d99678be2d216a85c3d"
...
kable(ethnicity_counts,  col.names = c("Ethnicity",  "Count"), caption = "Ethnicity")
